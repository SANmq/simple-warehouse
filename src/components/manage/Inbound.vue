    ...
    <div class="set-in">
        ...
        <el-form :model="form" label-width="80px" @submit.prevent="submit">
            ...
            <template v-if="active===1">
                <el-form-item :label="value.name" v-for="(value,index) in form.parameters" class="params" :key="value.name">
                    <el-input v-model="value.value"></el-input>
                    <el-button type="danger" @click="deleteParams(index)" style="margin-left: 10px">删除</el-button>
                </el-form-item>

                <el-form-item style="text-align: center">
                    <el-button type="primary" @click="prev">上一步</el-button>
                    <el-button type="primary" @click="addParams">新增自定义参数</el-button>
